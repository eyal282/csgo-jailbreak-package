...
/* Plugin Functions */
public APLRes : AskPluginLoad2(Handle
                        : myself, bool
                        : late, String
                        : error[], err_max)
{
...
public Action : Timer_CheckUpdates(Handle
                            : timer)
{
	Updater_FreeMemory();
...
public OnVersionChanged(Handle
                 : convar, const String
...
public OnSettingsChanged(Handle
                  : convar, const String
                  : oldValue[], const String
                  : newValue[])
{
